            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-7 d-none d-md-block">
                  <button type="button" class="btn btn-primary float-right"><i class="fa fa-cloud-download"></i></button>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4">
                      ...
                      <ul class="icons-list">
                        <li>
                          <i class="fa fa-desktop bg-primary"></i>
                          <div class="desc">
                        ...
                        <li>
                          <i class="fa fa-mobile bg-info"></i>
                          <div class="desc">
                        ...
                        <li>
                          <i class="fa fa-mobile bg-warning"></i>
                          <div class="desc">
                        ...
                        <li>
                          <i class="fa fa-spotify bg-success"></i>
                          <div class="desc">
                        ...
                        <li>
                          <i class="fa fa-cloud-download bg-danger"></i>
                          <div class="desc">
                        ...
                        <li>
                          <i class="fa fa-camera bg-warning"></i>
                          <div class="desc">
                    ...
                    <tbody>
                      <tr>
                        <td class="text-center">
                          <div class="avatar">
                            <img src="<?php echo base_url('assets/template/img/avatars/1.jpg'); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
